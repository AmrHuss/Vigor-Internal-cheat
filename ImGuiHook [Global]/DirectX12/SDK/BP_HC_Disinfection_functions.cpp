...
#include "BP_HC_Disinfection_classes.hpp"
#include "BP_HC_Disinfection_parameters.hpp"
...
void ABP_HC_Disinfection_C::ExpectedHealing(float TimerDelay, class UHealthComponent* HealthComponent, float DeltaTime, float* ExpHeal)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_HC_Disinfection_C", "ExpectedHealing");

	Params::BP_HC_Disinfection_C_ExpectedHealing Parms{};
...
void ABP_HC_Disinfection_C::ApplyHealToComponent(class UBP_HealingComponent_C* HealingComponent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_HC_Disinfection_C", "ApplyHealToComponent");

	Params::BP_HC_Disinfection_C_ApplyHealToComponent Parms{};
