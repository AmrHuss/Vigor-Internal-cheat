...
public:
	...
	bool                                          bAllowControlWithoutCapture;                       // 0x0495(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USlider, bAllowControlWithoutCapture) == 0x000495, "Member 'USlider::bAllowControlWithoutCapture' has a wrong offset!");
