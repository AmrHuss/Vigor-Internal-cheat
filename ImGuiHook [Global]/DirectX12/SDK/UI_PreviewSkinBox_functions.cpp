...
#include "UI_PreviewSkinBox_classes.hpp"
#include "UI_PreviewSkinBox_parameters.hpp"
...
void UUI_PreviewSkinBox_C::FillContent(TArray<class UClass*>& VariantItems, class UClass* BaseItem_0, const class FString& OrangeDotPrefix, TArray<class UClass*>& OwnedItems, const struct FDateTime& Time, TArray<class UClass*>* VisibleVariants)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_PreviewSkinBox_C", "FillContent");

	Params::UI_PreviewSkinBox_C_FillContent Parms{};
...
void UUI_PreviewSkinBox_C::SetFocusByIndex(int32 SlotIndex, class UClass** OutFocusedVariant, class UClass** OutFocusedBaseItem, int32* OutSelectedIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_PreviewSkinBox_C", "SetFocusByIndex");

	Params::UI_PreviewSkinBox_C_SetFocusByIndex Parms{};
...
void UUI_PreviewSkinBox_C::UpdateTics(int32 TickedIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_PreviewSkinBox_C", "UpdateTics");

	Params::UI_PreviewSkinBox_C_UpdateTics Parms{};
...
// Function UI_PreviewSkinBox.UI_PreviewSkinBox_C.ClearContent
// (Public, BlueprintCallable, BlueprintEvent)

void UUI_PreviewSkinBox_C::ClearContent()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_PreviewSkinBox_C", "ClearContent");
...
void UUI_PreviewSkinBox_C::GetIndexOfVariant(class UClass* Variant, int32* Index_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_PreviewSkinBox_C", "GetIndexOfVariant");

	Params::UI_PreviewSkinBox_C_GetIndexOfVariant Parms{};
...
void UUI_PreviewSkinBox_C::ResetFocus(int32 SlotIndex, class UClass** OutFocusedVariant, class UClass** OutFocusedBaseItem, int32* OutSelectedIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_PreviewSkinBox_C", "ResetFocus");

	Params::UI_PreviewSkinBox_C_ResetFocus Parms{};
